...
import { Menu, LogOut, User, Settings, Car, List, ClipboardList } from "lucide-react"
         ...
         <div className="hidden md:flex items-center space-x-3">
           {session?.user && (
             <>
               {isAdmin ? (
                 <>
                   <Button variant="ghost" asChild className="text-gray-700 hover:text-gray-900 hover:bg-gray-50">
